...
namespace ProgrammingPOE.Util
{
    public static class RecipeConstants
    {
        ...
        public const string INGREDIENT_NAME_PROMPT = "Name:";
        public const string QUANTITY_PROMPT = "Quantity:";
        ...
        public const string VIEW_RECIPES_PROMPT = "\nEnter the name of the recipe to display, or 'back' to return to the main menu:";
        public const string DELETE_RECIPE_PROMPT = "\nEnter the name of the recipe to delete or 'back' to return to the main menu:";
